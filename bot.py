...
def services_kb():
    ...
    btns.append([InlineKeyboardButton("🏠 Старт", callback_data="back_main")])
...
def back_kb():
    return InlineKeyboardMarkup([[InlineKeyboardButton("🏠 Старт", callback_data="back_main")]])
...
async def button(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "back_main":
        ...
        await send_photo_text(update, ctx, "SUCCESS",
            ...
            InlineKeyboardMarkup([[InlineKeyboardButton("🏠 Старт", callback_data="back_main")]]))
        ctx.user_data.clear()
        return MAIN_MENU
